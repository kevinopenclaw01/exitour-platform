...
import { almatyHotelGuide, kazakhstanFaqs, kazakhstanKakaoMessage, kazakhstanQuotePrefills } from "@/lib/mock/kazakhstanPremium";
    ...
    <>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl space-y-8 px-5 py-14 sm:px-6 lg:px-8">
          ...
          <PremiumCTA message={kazakhstanKakaoMessage} href={buildQuoteUrl(kazakhstanQuotePrefills.hotelConsulting)} />
        </div>
      </section>
    </>
  );
