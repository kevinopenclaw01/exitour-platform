...
export default function PremiumCTA({ message }: { message: string }) {
  return (
    <section className="rounded-lg bg-slate-950 p-6 text-white shadow-sm sm:p-8">
      ...
      <Link href="/quote" className="mt-6 inline-flex rounded-md bg-cyan-400 px-5 py-3 text-sm font-black text-slate-950 transition hover:bg-cyan-300">
        견적 요청으로 이동
      </Link>
    </section>
  );
